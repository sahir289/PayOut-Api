  ...
  return (
    <div className="drawer-side  z-30  ">
      ...
      <ul className="menu  pt-2 w-64 bg-base-100 min-h-full   text-base-content">
        ...
        <li className="mb-2 font-semibold text-xl flex">

          {/* <Link to={'/app/welcome'}><img className="mask mask-squircle w-10" src="/logo192.png" alt="A2X-PAY logo" /></Link> */}
          <div className=''>
            <img className="mask mask-squircle w-10" src="/logo192.png" alt="A2X-PAY logo" />
            <p>Payout</p>
          </div>
        </li>
